...
class homeExercise extends StatefulWidget {
  String acountDate;
  @override
  homeExercise({this.acountDate});
  @override
  State<StatefulWidget> createState() => homeExerciseState();
}

class homeExerciseState extends State<homeExercise> with AutomaticKeepAliveClientMixin<homeExercise> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return  RefreshIndicator(
      ...
      !_connection && !_isLoading
          ? _errorConnection()
          :homeExercises.length == 0 && _isLoading
          ? loadingView()
        ...
        child: NotificationListener<OverscrollIndicatorNotification>(
          onNotification: (overscroll) {
            ...
            itemCount: homeExercises.length,
              ...
              return GestureDetector(
                            ...
                            children: <Widget>[
                               ClipRRect(
                                ...
                                child: FadeInImage(
                                  ...
                                  image: NetworkImage(homeExercises[index].cover),
                                  fit: BoxFit.cover,
                ...
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => Directionality(textDirection: TextDirection.rtl, child:exerciseCat(catId: homeExercises[index].id,etebar:etebar),)
                    ),
                  );}
              );
  ...
  _getExercise({ bool refresh : false,String page='1'}) async {
    if( await checkConnectionInternet()) {
      ...
      setState(() {
        ...
        list.forEach((item) {
          if(item.type=="exercise-home")
            homeExercises.add(item);
