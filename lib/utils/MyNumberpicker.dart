...
class MyNumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle =  TextStyle(fontSize: 13,fontWeight: FontWeight.w400 );
    TextStyle selectedStyle = TextStyle(fontSize: 15,fontWeight: FontWeight.w500);
        ...
        child: new Container(
          ...
          child: Stack(
            children: <Widget>[
              ...
              _MyNumberPickerSelectedItemDecoration(
...
class _MyNumberPickerSelectedItemDecoration extends StatelessWidget {
  final Axis axis;
  final double itemExtent;
  final Decoration decoration;

  const _MyNumberPickerSelectedItemDecoration(
      {Key key,
        @required this.axis,
...
class MyNumberPickerDialog extends StatefulWidget {
  ...
  @override
  State<MyNumberPickerDialog> createState() =>
      new _MyNumberPickerDialogControllerState(
          initialIntegerValue, initialDoubleValue);
}

class _MyNumberPickerDialogControllerState extends State<MyNumberPickerDialog> {
  int selectedIntValue;
  double selectedDoubleValue;

  _MyNumberPickerDialogControllerState(
  ...
  Widget _buildMyNumberPicker() {
    if (widget.decimalPlaces > 0) {
      return new MyNumberPicker.decimal(
      ...
      return new Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
    Image.asset( 'assets/icons/vscroll.png',width: 20,height: 35, ),
    Expanded(
    child: MyNumberPicker.integer(
