...
class AutoCompleteTextField2<T> extends StatefulWidget {
...
class AutoCompleteTextFieldState<T> extends State<AutoCompleteTextField2> {
...
class SimpleAutoCompleteTextField extends AutoCompleteTextField2<String> {
  final StringCallback textChanged, textSubmitted;
  final int minLength;
  final ValueSetter<bool> onFocusChanged;
  final TextEditingController controller;
