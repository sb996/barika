...
const double _kDatePickerFontSize = 20.0;
...
class _DatePickerState extends State<_DatePickerComponent> {
  ...
  // int selectedIntValue=_currentYear;
  ...
  void _handleValueChanged2(num value) {


    if (value is int) { if (_currentMonth != value) {
      setState(() {
        _currentMonth = value;
      });
  ...
  void _handleValueChanged3(num value) {
    if (value is int) { if (_currentDate != value) {
      setState(() {
        _currentDate = value;
      });
  ...
  Widget _renderYearsPickerComponent(String yearAppend) {
    return new Expanded(
      ...
      child: Container(
          ...
          height: _kDatePickerHeight+50,
          decoration: BoxDecoration(color: Colors.white),
          child:new MyNumberPicker.integer(
              itemExtent:  _kDatePickerItemHeight+50,
              initialValue: _currentYear??1370,
  ...
  Widget _renderMonthsPickerComponent(String monthAppend, {String format}) {
    return new Expanded(
      ...
      //         return Container(
      //           height: _kDatePickerItemHeight+50,
      ...
      //                     style: TextStyle(
      //                         color: Colors.black, fontFamily: "iransansDN",fontSize: _kDatePickerFontSize),
  ...
  Widget _renderTitleActionsView() {
    ...
    return Container(
        ...
        height: _kDatePickerTitleHeight+50,
        decoration: BoxDecoration(color: Colors.white),
        child: Column(
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                Text("انتخاب تاریخ",          style: TextStyle(
                    color: Colors.black, fontFamily: "iransansDN",fontSize: _kDatePickerFontSize),),
                Container(
                  height: _kDatePickerTitleHeight,
                  child: FlatButton(
            ...
            Expanded(child: Container(
                ...
                height: 50,
                decoration: BoxDecoration(color: Colors.white), child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
...
class _BottomPickerLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    double maxHeight = _kDatePickerHeight+50;
    if (showTitleActions) {
      maxHeight += _kDatePickerTitleHeight+50;
    }
