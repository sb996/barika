...
//import 'package:barika/store/Firstpayment.dart';
//
...
//              DbAllDiets allDiet = DbAllDiets.fromJson(diet);
//              id = await _saveAllDiets(allDiet);
//              await clicksave(dietNameSelector(allDiets[index].regimName.toString())+"%"+allDiets[index].userInfo["name"].toString(),allamount.length);
////        print(id.toString()+"iddddddddddddddadddddddddd");
//
//              for (int i = 0; i < allamount.length; i++) {
//                allBreakFast = [];
...
//  await setAlarm(timesTamdid: timesTamdid,timealarmTamdid: timealarmTamdid,timealarm: null,times: null);}
